...
$isSmartPhone = ((strpos($ua, 'Android') !== false) || (strpos($ua, 'Mobile') !== false) || (strpos($ua, 'iPhone') !== false) || (strpos($ua, 'iPad') !== false) || (strpos($ua, 'Windows Phone') !== false));
      ...
      <div id="content">
        ...
        <section id="section-aboutme" class="content">
          ...
          <div id="myname">
            ...
            <p style="font-size: 1.7em; padding-left: 1em;"><span>亀岡&nbsp;亮太</span> /&nbsp;<span>カメオカ&nbsp;リョウタ</span></p>
          </div>
          <div id="profile">
            <div>
...
<?php
foreach ($sites as $site) {
  echo '              <a id="link-' . $site[1] . '" href="' . $site[2] . '" target="_blank">' . $site[0] . '</a>';
}
?>
          </div>
        </section>
        ...
        <section id="section-twitter">
          ...
          <div id="timeline">
            ...
            for ($i = 0; $i < 10; $i++) {
              ...
              . '<p class="datetime"><a href="#" target="_blank"></a></p></div>';
            }
            ?>
          </div>
        </section>
